...
- **Exact next implementation task:** اجرای بسته ۱ (`DB-01/DB-02`) روی نسخه تولیدی ناشناس‌شده و موردتأیید مالک: تهیه و آزمون بازشدن backup بایت‌به‌بایت خارج از Repository، export و امضای baseline زنده schema/relationship/index، سپس اجرای profileهای فقط‌خواندنی و نگهداری exceptionها؛ پیش از امضای gate هیچ DDL یا بسته ۲ آغاز نشود.
